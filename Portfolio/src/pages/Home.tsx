 ...
 <table className="w-full max-w-4xl mx-auto border border-gray-300 rounded-lg shadow-lg bg-gray-400">
  <tbody>
    ...
    <tr className="border-b border-gray-300">
      ...
      <td className="p-4">
        <img className="w-20 hover:scale-110 transition-transform" src="/Unofficial_JavaScript_logo_2.svg.png" alt="JavaScript" />
      </td>
      <td className="p-4">
        <img className="w-24 hover:scale-110 transition-transform" src="/css3-logo-png_seeklogo-186678-removebg-preview.png" alt="CSS3" />
      </td>
      <td className="p-4">
    ...
    <tr>
      ...
      <td className="p-4">
        <img className="w-24 hover:scale-110 transition-transform" src="/download-removebg-preview.png" alt="Figma" />
      </td>
      <td className="p-4">
    ...
    <tr>
      <td className="p-4">
        <img className="w-20 hover:scale-110 transition-transform" src="/Adobe Xd.png" alt="Adobe Xd" />
      </td>
      <td className="p-4">
        <img className="w-20 hover:scale-110 transition-transform" src="/Photoshop.png" alt="Photoshop" />
      </td>
      <td className="p-4">
        <img className="w-20 hover:scale-110 transition-transform" src="/Tailwind css.png" alt="Tailwind CSS" />
      </td>
      </tr>
  </tbody>
</table>
